...
return {
  apply(ctx) {
    ...
    function oklchToRgbUnclamped(color) {
    ...
    function solveOklchLightness(base, against, minContrast, direction) {
    ...
    function createVividColors(appearance, bgSeed, accentSeed) {
      const dark = appearance === 'dark'
